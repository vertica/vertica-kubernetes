...
func (c *CmdClusterHealth) Run(vcc vclusterops.ClusterCommands) error {
	...
	case "get_slow_events":
		bytes, err = json.MarshalIndent(options.SlowEventsResult, "" /*prefix*/, " " /* indent for four spaces*/)
	case "get_session_starts":
		bytes, err = json.MarshalIndent(options.SessionStartsResult, "" /*prefix*/, " " /* indent for four spaces*/)
	case "get_transaction_starts":
		bytes, err = json.MarshalIndent(options.TransactionStartsResult, "" /*prefix*/, " " /* indent for four spaces*/)
