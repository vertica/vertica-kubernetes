...
func (op *httpsCheckRunningDBOp) handleDBRunning(allErrs error, msg string, upHosts mapset.Set[string],
	downHosts, exceptionHosts map[string]bool,
...
func (op *httpsCheckRunningDBOp) checkProcessedResult(sandboxedHosts map[string]string,
	mainClusterHosts map[string]struct{}, upHosts mapset.Set[string]) bool {
