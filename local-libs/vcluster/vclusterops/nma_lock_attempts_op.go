...
const (
	userName       = "dkr_dbadmin"
	lockObjectName = "Global Catalog"
)

// TODO: We should let the endpoint just accept the seconds
const minLockWaitDuration = "00:00:30"

func makeNMALockAttemptsOp(upHosts []string,
...
func (op *nmaLockAttemptsOp) setupRequestBody() error {
	...
	for _, host := range op.hosts {
		...
		} else { // TODO: this condition must be removed, which is only for testing
