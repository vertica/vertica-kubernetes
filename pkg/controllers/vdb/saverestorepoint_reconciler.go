...
// SaveRestorePoint saves a restore point to an archive, and create the archive if it doesn't exist
...
// in the status.
func (s *SaveRestorePoint) updateVDB(ctx context.Context, start, end time.Time) error {
