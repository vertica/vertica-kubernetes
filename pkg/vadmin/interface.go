...
type Dispatcher interface {
	...
	// VStopSubcluster will stop a subcluster from Vertica db
	VStopSubcluster(ctx context.Context, opts ...stopsubcluster.Option) error
...
type VClusterProvider interface {
	...
	VStopSubcluster(optiios *vops.VStopSubclusterOptions) error
