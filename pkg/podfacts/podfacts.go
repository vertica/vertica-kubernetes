...
import (
	...
	"github.com/vertica/vertica-kubernetes/pkg/reconciler"
...
type PodFacts struct {
	VRec               *reconciler.VerticaDBReconciler
...
func MakePodFacts(vrec *reconciler.VerticaDBReconciler, prunner cmds.PodRunner) PodFacts {
