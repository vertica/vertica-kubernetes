...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpgradeState) DeepCopyInto(out *UpgradeState) {
	*out = *in
	if in.ReplicaGroups != nil {
		in, out := &in.ReplicaGroups, &out.ReplicaGroups
		*out = make([][]string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpgradeState.
func (in *UpgradeState) DeepCopy() *UpgradeState {
	if in == nil {
		return nil
	}
	out := new(UpgradeState)
	in.DeepCopyInto(out)
	return out
}
