...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TLSMode) DeepCopyInto(out *TLSMode) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSMode.
func (in *TLSMode) DeepCopy() *TLSMode {
	if in == nil {
		return nil
	}
	out := new(TLSMode)
...
func (in *VerticaDBStatus) DeepCopyInto(out *VerticaDBStatus) {
	*out = *in
	...
	if in.TLSModes != nil {
		in, out := &in.TLSModes, &out.TLSModes
		*out = make([]TLSMode, len(*in))
		copy(*out, *in)
	}
}
