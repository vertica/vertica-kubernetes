...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DBTLSConfig) DeepCopyInto(out *DBTLSConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DBTLSConfig.
func (in *DBTLSConfig) DeepCopy() *DBTLSConfig {
	if in == nil {
		return nil
	}
	out := new(DBTLSConfig)
...
func (in *VerticaDBStatus) DeepCopyInto(out *VerticaDBStatus) {
	*out = *in
	...
	if in.ObservedConfigMaps != nil {
		in, out := &in.ObservedConfigMaps, &out.ObservedConfigMaps
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ObservedSecrets != nil {
		in, out := &in.ObservedSecrets, &out.ObservedSecrets
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
