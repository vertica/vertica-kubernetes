...
type VerticaDBSpec struct {
	...
	// +operator-sdk:csv:customresourcedefinitions:type=spec,xDescriptors="urn:alm:descriptor:com.tectonic.ui:advanced"
	// +kubebuilder:validation:Optional
	// Identifies HTTPS NMA TLS configurations
	HTTPSNMATLS *TLSConfigSpec `json:"httpsNMATLS,omitempty"`
...
type LicenseStatus struct {
	...
	// +operator-sdk:csv:customresourcedefinitions:type=status
	// +optional
	// Timestamp of last license validation
...
type LicenseInfo struct {
	// +operator-sdk:csv:customresourcedefinitions:type=status
	// the key used in the license secret
	Key string `json:"key"`
	// +operator-sdk:csv:customresourcedefinitions:type=status
	...
	// +operator-sdk:csv:customresourcedefinitions:type=status
	// populated after the license is installed
