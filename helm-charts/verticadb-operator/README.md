...
| clusterScopeReleaseName | If the operator is deployed in namespace scope, and you want prometheus or loki to monitor databases in the namespace, then you must set this to the release name of the cluster scope operator that has prometheus or loki enabled. | "" |
